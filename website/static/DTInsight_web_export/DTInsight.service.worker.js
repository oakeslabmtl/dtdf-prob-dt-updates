...
/** @type {string} */
const CACHE_VERSION = '1750793264|30619376173';
/** @type {string} */
const CACHE_PREFIX = 'DTInsight-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'DTInsight.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["DTInsight.html","DTInsight.js","DTInsight.offline.html","DTInsight.icon.png","DTInsight.apple-touch-icon.png","DTInsight.audio.worklet.js","DTInsight.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["DTInsight.wasm","DTInsight.pck"];
